...
type IconName = 'home' | 'user' | 'arrowLeft' | 'share' | 'whatsapp' | 'tiktok' | 'tokopedia' | 'shopee' | 'lazada' | 'edit' | 'trash' | 'plus' | 'sparkles' | 'logout' | 'cart' | 'search' | 'menu' | 'heart' | 'star' | 'microphone' | 'close' | 'eye' | 'eye-slash' | 'copy' | 'twitter' | 'facebook' | 'email' | 'link' | 'arrowUp' | 'ticket' | 'instagram';
