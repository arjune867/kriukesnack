...
const WishlistPage: React.FC<WishlistPageProps> = ({ navigate }) => {
    ...
    if (wishlistedProducts.length === 0) {
        return (
            <div className="text-center p-8 flex flex-col items-center justify-center h-full">
                <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200">Wishlist Kosong</h1>
                <p className="text-gray-600 dark:text-gray-300 mb-6">Simpan produk yang kamu suka dengan menekan ikon hati!</p>
                <button
    ...
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">Wishlist Saya</h1>
